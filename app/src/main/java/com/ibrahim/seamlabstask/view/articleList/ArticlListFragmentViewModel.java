...
public class ArticlListFragmentViewModel extends AndroidViewModel {
    ...
    public ArticlListFragmentViewModel(@NonNull Application application) {
        super(application);
    ...
    public void getArticle() {
        ...
        call.enqueue(new Callback<ArticleResponse>() {
            ...
            public void onResponse(Call<ArticleResponse> call, Response<ArticleResponse> response) {
                Log.d(TAG, "onResponse: 1"+response.body().getArticles().size());
